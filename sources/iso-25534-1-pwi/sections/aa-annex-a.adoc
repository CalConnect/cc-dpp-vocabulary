...
The terms and definitions clauses of the following source documents were extracted in full and verified concept by concept. <<table-a-1,Table A.1>> records, per source document, the number of concepts in this document that cite it and the clauses cited. The extraction comprised 141 term entries (82 from the EN 182xx series, 30 from CWA 18291:2025 and 29 from IDTA 01001-3.2:2026); ISO/AWI 25534-1 contributes the conflicting definition of the head term recorded in 3.1, together with the terms newly introduced in 3.4 (life cycle, circular economy, product circularity, traceability, value chain) and 3.5 (validation, verification) that were not previously represented in the source corpus. Concepts carried forward from the extraction carry source citations in their entries; lineage citations (standards from which a source document itself adopted a definition) are recorded in the source blocks of the entries.
...
The machine-readable concept dataset from which the entries of 3.1 to 3.7 are converted is maintained by the UniDPP harmonization project and is published at https://www.glossarist.org/dpp/ (mirror https://www.unidpp.org/terminology/).
