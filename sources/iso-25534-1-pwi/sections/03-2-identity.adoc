...
NOTE: Regional variant: the definition recorded from the merged concept pair was: string of characters that is required to be unique among all identifiers used for all objects for a specific purpose
