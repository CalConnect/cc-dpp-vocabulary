...
NOTE: Domain-scoped entry — the criteria of application of this concept are owned by the communities (jurisdictional, sectoral or cultural) that govern it; this entry is recorded for navigational completeness and does not harmonize those criteria across communities (see the Introduction).
